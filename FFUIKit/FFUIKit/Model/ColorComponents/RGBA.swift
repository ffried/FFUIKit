...
fileprivate extension RGBBaseColorComponents where Value: BinaryInteger {
    @inline(__always)
    func rgbHexString(uppercase: Bool) -> String {
        return red.hexString(uppercase: uppercase) + green.hexString(uppercase: uppercase) + blue.hexString(uppercase: uppercase)
    }
}

fileprivate extension RGBBaseColorComponents where Self: ColorComponents, Value: BinaryInteger {
    @inline(__always)
    func rgbaHexString(uppercase: Bool) -> String {
        return rgbHexString(uppercase: uppercase) + alpha.hexString(uppercase: uppercase)
    }
}

extension RGBColorComponents where Value: BinaryInteger {
    public func hexString(prefix: String = "", postfix: String = "", uppercase: Bool = false) -> String {
        return prefix + rgbHexString(uppercase: uppercase) + postfix
    }
}

extension RGBAColorComponents where Value: BinaryInteger {
    public func hexString(prefix: String = "", postfix: String = "", uppercase: Bool = false) -> String {
        return prefix + rgbaHexString(uppercase: uppercase) + postfix
    }
}
...
extension RGBColorComponents where Self: UIOpaqueColorCompontents, Value: BinaryFloatingPoint {
    @inlinable
    public var color: UIColor { return UIColor(red: .init(red), green: .init(green), blue: .init(blue), alpha: 1) }
...
extension RGBAColorComponents where Self: UIOpaqueColorCompontents, Value: BinaryFloatingPoint {
    @inlinable
    public var color: UIColor { return UIColor(red: .init(red), green: .init(green), blue: .init(blue), alpha: .init(alpha)) }
