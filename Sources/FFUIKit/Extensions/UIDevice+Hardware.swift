...
@usableFromInline
func _currentPlatformName() -> String? { _platformNameMapping[_currentPlatform()] }

#if !os(watchOS)
extension UIDevice {
    @inlinable
    public final var platform: String { _currentPlatform() }

    @inlinable
    public final var platformName: String? { _currentPlatformName() }
}
#else
